...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request ->validate([
                ...
                'mota' =>'required|unique:categories|max:255',
                'is_active' => 'required'
            ],
            [
    ...
    $posts = $category->posts()->paginate(10); // Phân trang nếu cần
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('category.index')->with('status','Xoá thành công danh mục');
    }
}